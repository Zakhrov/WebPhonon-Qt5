...
{
    url=QFileDialog::getOpenFileName(this,"Choose File",QStandardPaths::locate(QStandardPaths::MoviesLocation,"",QStandardPaths::LocateDirectory),tr("Videos (*.avi *.mp4 *.mpg *.mkv *.m4v *.ogv *.wmv)"));
