...
{
    url=QFileDialog::getOpenFileName(this,"Choose File",QStandardPaths::locate(QStandardPaths::MusicLocation,"",QStandardPaths::LocateDirectory),tr("Songs (*.wav *.mp3 *.m4a *.flac *.ogg *.wma)"));
